...
public class MovieController {
    ...
    @GetMapping("/search")
    @Operation(summary = "Поиск фильмов по названию", description = "Возвращает список фильмов, соответствующих запросу")
    @ApiResponse(responseCode = "200", description = "Список найденных фильмов", content = {
